...
const bibleVerses = [
    ...
    "«Господь — то мій Пастир, тому в недостатку не буду. Він на пасовиськах зелених оселить мене, на тихую воду мене запровадить» (Псалом 23:1-2)",
    "«Бо саме Божою милістю спаслися ви завдяки вірі. Спасіння не є ваша заслуга, то є дар Божий. То не винагорода за чийсь труд, й не те, чим хтось міг би хвалитися» (Ефесян 2:8-9)",
    ...
    "«Господь буде стерегти твій вихід та вхід твій відтепер і аж довіку. Він не дасть нозі твоїй спіткнутися, і не здрімає Той, Хто тебе стереже» (Псалом 121:3,8)",
    "«Прийдіть до Мене, усі струджені та обтяжені, — і Я заспокою вас! Візьміть на себе ярмо Моє, і навчіться від Мене, бо Я тихий і серцем покірливий, — і знайдете спокій душам своїм» (Від Матвія 11:28-29)"
];
